...
export const EmptyCart = () => {
  ...
  return (
    <div className='w-full h-screen flex items-center justify-center px-20  md:pt-14 '>
        <div className='items-center flex flex-col justify-center'>
<img className='w-40' src="/shopping.png" alt="shopping" />
<h4 className='font-bold text-xl'>Your cart is empty</h4>
 <p className='my-2 text-center'>You can go to menu page to view more bakes</p>
